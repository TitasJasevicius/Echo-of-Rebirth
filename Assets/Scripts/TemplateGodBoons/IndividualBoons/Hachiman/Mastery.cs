...
public class Mastery : MonoBehaviour
{
  ...
  public void ApplyBoon(PlayerResources playerResources)
  {
    ...
    if (Activated == false && playerResources.money >= DiscountedPrice)
    {
      playerResources.IncreaseCritMultiplier(CritMultiplier);
      Activated = true;
      playerResources.money -= DiscountedPrice;
      Debug.Log($"Mastery crit multiplier increased by {CritMultiplier}.");
    }
  }
  public void SetCritMultiplier(float amount)
  {
